          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 2:
                ...
                return _context7.abrupt('return', new Navigator(this.options, { status: status, location: location, response: response, resource: _Resource2.default.fromObject(responseBody) }).followRedirect(config));
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 2:
                ...
                return _context8.abrupt('return', new Navigator(this.options, { status: status, location: location, response: response, resource: _Resource2.default.fromObject(responseBody) }).followRedirect(config));
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 2:
                ...
                return _context9.abrupt('return', new Navigator(this.options, { status: status, location: location, response: response, resource: _Resource2.default.fromObject(responseBody) }).followRedirect(config));
